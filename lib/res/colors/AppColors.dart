...
import 'package:ovian_test/res/colors/BaseColors.dart';
...
class AppColors implements BaseColors{
  ...
  @override
  Color get colorGrey => const Color.fromARGB(255, 100, 104, 112);

  @override
  Color get statusGrey => const Color.fromARGB(255, 26, 27, 29);
}